        ...
        <Fragment>
            {isConnected ? 
                (<div className="profilCartouche">
                    <div>
                        {isAdmin ?
                            (<svg className="icon--avatar" viewBox="0 0 46 46" width="46" height="46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M39 18v-.3A16.8 16.8 0 0023.2 7 16.8 16.8 0 007.6 18 6.8 6.8 0 0010.8 31c.6 0 1.1-.5 1.1-1.1V27c.7 2 2 3.8 3.6 5.2-2 1.4-3.5 3.2-4.6 5.3a1.1 1.1 0 102 1c1-2 2.6-3.7 4.6-4.9a11.8 11.8 0 003 1.2 1.1 1.1 0 00.3-2.2 9.7 9.7 0 117.6-1.2c-.4.2-.8.5-1.3.6a1.1 1.1 0 101 2l.8-.4c1 .6 1.9 1.3 2.6 2-1.3 1-2.7 1.6-4.3 2-.5-.5-1.2-1-2-1h-3.7a2.7 2.7 0 000 5.4H25c1.3 0 2.4-1 2.7-2.2 1.8-.5 3.6-1.3 5.1-2.4l.8 1.5a1.1 1.1 0 102-1l-1-1.9c1.7-1.6 3-3.5 4-5.8A6.8 6.8 0 0039 18zM25 39.8h-3.6a.5.5 0 01-.5-.5c0-.2.2-.4.5-.4h3.6c.2 0 .4 0 .4.2v.2h.1c0 .3-.2.5-.5.5zM9.7 28.5a4.6 4.6 0 010-8.9v9zm23.6 5.8c-.7-.8-1.5-1.5-2.4-2a12 12 0 003.8-6.1v3.6c0 .6.5 1 1.1 1h.1c-.7 1.3-1.6 2.5-2.6 3.5zm2.5-17c-.6 0-1 .5-1 1v2a11.9 11.9 0 00-22.9-.8v-1.1c0-.6-.5-1.1-1-1.1h-.6c2.5-4.9 7.5-8 13-8s10.6 3.1 13 8h-.5zM37 28.5v-8.9a4.6 4.6 0 010 9z" fill="#444"/>
                                <path d="M19.7 26.4a5.7 5.7 0 006.9 0 1.1 1.1 0 10-1.3-1.8c-2 1.6-4 .2-4.2 0a1.1 1.1 0 00-1.4 1.8zM21.5 20.9a1.3 1.3 0 00-2.6 0 1.3 1.3 0 002.6 0zM27.5 20.9a1.3 1.3 0 10-2.6 0 1.3 1.3 0 002.6 0z" fill="#444"/>
                                <circle cx="23.5" cy="23" r="21.5" stroke="#56B693" strokeWidth="3"/>
                            </svg>)
                        :
