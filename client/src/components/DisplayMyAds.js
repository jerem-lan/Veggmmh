...
const DisplayMyAds = ({ id, userEmail, userId, currentIdUser, title, content, postcode, handleDeleteAds, creationDate, modificationDate, username }) => {	
	...
	return (
		...
		>
			...
			<div className="Tools">
				...
				<button className="btn btn--tool" onClick={() => handleDeleteAds(id)}>
					<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
